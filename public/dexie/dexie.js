...
//https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Structured_clone_algorithm
    var intrinsicTypes = "Boolean,String,Date,RegExp,Blob,File,FileList,ArrayBuffer,DataView,Uint8ClampedArray,ImageData,Map,Set"
        .split(',').concat(flatten([8, 16, 32, 64].map(function (num) {
    ...
    */
        ...
        function bulkDelete(idbstore, trans, keysOrTuples, hasDeleteHook, deletingHook) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (!hasDeleteHook) {
                    ...
                    var hookCtx, errorHandler = hookedEventRejectHandler(reject),
            ...
            where: function (indexOrCrit) {
                ...
                // and this browser supports compound indexes (maxKey !== maxString)!
                    return this
                        ...
                        .equals(compoundIndex.keyPath.map(function (kp) {
         ...
         * }
            ...
            return {
                ...
                modify: function (changes) {
                    var self = this, ctx = this._ctx, hook = ctx.table.hook, updatingHook = hook.updating.fire,
                ...
                'delete': function () {
                    var _this = this;
                    var ctx = this._ctx, range = ctx.range, deletingHook = ctx.table.hook.deleting.fire,
        ...
        function readGlobalSchema() {
            ...
            dbStoreNames.forEach(function (storeName) {
                var store = trans.objectStore(storeName), keyPath = store.keyPath,
